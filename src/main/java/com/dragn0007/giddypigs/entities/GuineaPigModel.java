...
public class GuineaPigModel extends AnimatedGeoModel<GuineaPig> {
    ...
    @Override
    public ResourceLocation getModelLocation(GuineaPig object) {
        return MODEL;
    }

    @Override
    public ResourceLocation getTextureLocation(GuineaPig object) {
        if(object.isBaby())
            return BABY_TEXTURE;
    ...
    @Override
    public ResourceLocation getAnimationFileLocation(GuineaPig animatable) {
        return ANIMATION;
    }
}
