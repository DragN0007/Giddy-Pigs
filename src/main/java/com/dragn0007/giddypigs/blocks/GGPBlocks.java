...
public class GGPBlocks {
    ...
    public static final DeferredRegister<BlockEntityType<?>> BLOCK_ENTITIES
            = DeferredRegister.create(ForgeRegistries.BLOCK_ENTITIES, GiddyGuineaPigs.MODID);
    ...
    private static <T extends PixelPlacer>RegistryObject<T> registerPixelPlacer(String name, Supplier<T> block) {
        RegistryObject<T> toReturn = BLOCKS.register(name, block);
        GGPItems.ITEMS.register("pixel_placement/" + name, () -> new PixelPlacerItem(toReturn.get(), new Item.Properties().tab(GGPItemGroup.GIDDY_PIGS_GROUP)));
        return toReturn;
    }
    ...
    protected static <T extends Block> void registerBlockItem(String name, RegistryObject<T> block) {
        GGPItems.ITEMS.register(name, () -> new BlockItem(block.get(),
                new Item.Properties().tab(GGPItemGroup.GIDDY_PIGS_GROUP)));
    }
