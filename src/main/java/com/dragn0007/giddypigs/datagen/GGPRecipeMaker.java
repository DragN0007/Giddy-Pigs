...
public class GGPRecipeMaker extends RecipeProvider implements IConditionBuilder {
    public GGPRecipeMaker(DataGenerator pGenerator) {
        super(pGenerator);
    }
    ...
    protected void buildCraftingRecipes(Consumer<FinishedRecipe> pFinishedRecipeConsumer) {
        ...
        ShapedRecipeBuilder.shaped(GGPBlocks.ENCLOSURE_PANE.get(), 16)
        ...
        ShapedRecipeBuilder.shaped(GGPBlocks.ENCLOSURE_PANE_CORNER.get(), 4)
                .define('A', Items.IRON_INGOT)
                .define('B', Items.GLASS_PANE)
                .pattern("BAB")
                .pattern("BAB")
        ...
        ShapedRecipeBuilder.shaped(GGPBlocks.GUINEA_PIG_HOUSE.get())
        ...
        ShapedRecipeBuilder.shaped(GGPBlocks.FOOD_DISH_BLACK.get())
                .define('A', Items.IRON_NUGGET)
        ...
        ShapedRecipeBuilder.shaped(GGPBlocks.FOOD_DISH_BROWN.get())
                .define('A', Items.IRON_NUGGET)
        ...
        ShapedRecipeBuilder.shaped(GGPBlocks.FOOD_DISH_WHITE.get())
                .define('A', Items.IRON_NUGGET)
        ...
        ShapedRecipeBuilder.shaped(GGPBlocks.WATER_BOTTLE.get())
                .define('A', Items.IRON_NUGGET)
                .define('B', Items.GLASS_PANE)
